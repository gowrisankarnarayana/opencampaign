	...
	<j:PageHeader />
            <j:MenuBar>
             ...
             <j:ContentArea>
                    ...
                    <j:Content>
                      <j:Block blockHeading="New Dynamic Template"> 
						<html:form action="/templates.html">
						<html:hidden styleId="mx" property="mx" value="prepareElements"/> 
						<html:hidden styleId="route" property="route" value="templates/dynamicTemplate/prepare"></html:hidden> 
						<html:hidden property="dynamic" value="1"></html:hidden>
                        <table width="100%"><tr>
                            ...
                            <html:textarea  rows="40" cols="120" styleId="htmlEditor" property="content"  /> 
                         	<script type="text/javascript">
                  	     	CKEDITOR.replace( 'htmlEditor',
									{ 
                  	     			    customConfig : '${pageContext.request.contextPath}/scripts/editor/dynamicBar.js',
										skin : 'kama',
										height:'350',
										toolbar:'DynamicBar',
